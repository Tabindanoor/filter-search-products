...
<img src={img}  className='w-[300px] h-[100px] text-center ' alt="" />
<p>{category} <b>{color}</b></p>
<b>{company} </b>
<p className=' text-center flex center justify-center text-yellow-500' >{star}{star}{star}{star} </p>
